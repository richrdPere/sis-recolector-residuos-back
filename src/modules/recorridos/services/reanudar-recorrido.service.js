...
// =======================================================
const reanudarRecorridoService = async ({
  id_recorrido,
  id_usuario,
  fecha_evento = null,
  latitud = null,
  ...
  try {
    ...
    if (
      ...
      throw new AppError(
        'Solo se puede reanudar un recorrido pausado.',
        409,
        'ROUTE_EXECUTION_CANNOT_RESUME',
      );
    }
...
module.exports = reanudarRecorridoService;